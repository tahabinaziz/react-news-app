...
//import { forgetStudentPassword } from '../../api/student';
...
export default function Register() {
    ...
    //   await forgetStudentPassword(data.email);
       console.log(email);
        ...
        <div className={''}>
            ...
            <div className='bg-secondary py-16 h-screen md:py-56 lg:py-24 xl:py-24'>
                ...
                <div className=" xs: max-w-xs  md:max-w-[700px] lg:max-w-lg xl:max-w-xl mx-auto bg-primary shadow-xl rounded">
                    <div className="text-center text-white py-4">Register User</div>
                        ...
                        <form>
                            <div className="w-4/5 mx-auto">
                                ...
                                <div className="flex items-center bg-white rounded shadow-md mb-4">
                                    ...
                                    <input className="w-full h-12  border-white"
                                        type="email"
                                        name="email"
                                        value={email || ''}
                                ...
                                <button onClick={onSubmit} disabled={isLoading} className="bg-primary hover:bg-primary block mx-auto text-white text-sm uppercase rounded shadow-md px-6 py-2">Sign in</button>
